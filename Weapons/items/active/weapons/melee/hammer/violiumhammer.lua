...
function init()
  ...
  animator.setAnimationState("bladefullbright", "inactive")
...
function update(dt, fireMode, shiftHeld)
  ...
  if nowActive then
    if self.activeTimer == 0 then
      ...
      animator.setAnimationState("bladefullbright", "extend")
  ...
  elseif self.activeTimer > 0 then
    ...
    if self.activeTimer == 0 then
      ...
      animator.setAnimationState("bladefullbright", "retract")
